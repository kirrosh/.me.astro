...
Here is a Solid JS example with row selection, filtering, and sorting, and also animated with simple, zero-config [AutoAnimate](https://auto-animate.formkit.com/)
